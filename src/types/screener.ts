...
export const INDICATOR_DEFINITIONS: IndicatorDefinition[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "window", label: "How Many Candles", type: "number" },
      { key: "candles_since_min", label: "Candles Since Event Min", type: "number" },
      { key: "candles_since_max", label: "Candles Since Event Max", type: "number" },
      { key: "min_consecutive_below", label: "Minimum Consecutive Below", type: "number" },
      { key: "below_candles_min", label: "Below Candles Min", type: "number" },
      { key: "below_candles_max", label: "Below Candles Max", type: "number" },
